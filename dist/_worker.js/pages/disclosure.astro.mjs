...
</p> </div> <!-- Content --> <div class="space-y-6"> <!-- Section 1 --> <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-200 dark:border-gray-700"> <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">What Are Affiliate Links?</h2> <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
...
</p> </div> <!-- Section 2 --> <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-200 dark:border-gray-700"> <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Our Commitment to Honesty</h2> <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
...
</p> </div> </div> <!-- Section 4 --> <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-200 dark:border-gray-700"> <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Your Trust Matters</h2> <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
We understand that trust is earned, and we work hard to maintain it. 
          ...
          please <a href="/contact" class="text-blue-600 dark:text-blue-400 hover:underline">let us know</a>.
...
</p> </div> </div> <!-- Section 5 --> <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-200 dark:border-gray-700"> <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Transparency Badge</h2> <p class="text-gray-600 dark:text-gray-300 leading-relaxed">
...
</p> </div> </div> <!-- Last Updated --> <div class="text-center text-sm text-gray-400 dark:text-gray-500 pt-4 border-t border-gray-200 dark:border-gray-700"> <p>Last updated: ${(/* @__PURE__ */ new Date()).toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" })}</p> </div> </div> </div> ` })}`;
