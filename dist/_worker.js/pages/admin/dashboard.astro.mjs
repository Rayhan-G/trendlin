...
const $$Dashboard = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Array.isArray(posts) ? posts.filter((p) => p.is_draft).length : 0;
...
New Post
</a> </div> </div> </div>  <div class="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-8 gap-4 sm:gap-6 mb-8"> <!-- Total Posts --> <div class="bg-white rounded-2xl p-4 border border-gray-100 hover:shadow-lg transition-all duration-200"> <div class="flex items-center justify-between"> <div> <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Posts</p> <p class="text-xl font-bold text-gray-900 mt-1">${totalPosts}</p> </div> <div class="w-9 h-9 bg-blue-50 rounded-xl flex items-center justify-center text-blue-600"> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z"></path> </svg> </div> </div> <div class="mt-2 flex items-center gap-1 text-xs text-gray-400"> <span class="w-1 h-1 rounded-full bg-blue-500"></span> <span>${publishedPosts} published</span> </div> </div> <!-- Products --> <div class="bg-white rounded-2xl p-4 border border-gray-100 hover:shadow-lg transition-all duration-200"> <div class="flex items-center justify-between"> <div> <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Products</p> <p class="text-xl font-bold text-orange-600 mt-1">${totalProducts}</p> </div> <div class="w-9 h-9 bg-orange-50 rounded-xl flex items-center justify-center text-orange-600"> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path> </svg> </div> </div> <div class="mt-2 flex items-center gap-1 text-xs text-gray-400"> <span class="w-1 h-1 rounded-full bg-orange-500"></span> <span>${productsInStock} in stock</span> </div> </div> <!-- Resources --> <div class="bg-white rounded-2xl p-4 border border-gray-100 hover:shadow-lg transition-all duration-200"> <div class="flex items-center justify-between"> <div> <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Resources</p> <p class="text-xl font-bold text-purple-600 mt-1">${totalResources}</p> </div> <div class="w-9 h-9 bg-purple-50 rounded-xl flex items-center justify-center text-purple-600"> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1"></path> </svg> </div> </div> <div class="mt-2 flex items-center gap-1 text-xs text-gray-400"> <span class="w-1 h-1 rounded-full bg-purple-500"></span> <span>product links</span> </div> </div> <!-- Templates --> <div class="bg-white rounded-2xl p-4 border border-gray-100 hover:shadow-lg transition-all duration-200"> <div class="flex items-center justify-between"> <div> <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Templates</p> <p class="text-xl font-bold text-indigo-600 mt-1">${totalTemplates}</p> </div> <div class="w-9 h-9 bg-indigo-50 rounded-xl flex items-center justify-center text-indigo-600"> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path> </svg> </div> </div> <div class="mt-2 flex items-center gap-1 text-xs text-gray-400"> <span class="w-1 h-1 rounded-full bg-indigo-500"></span> <span>${activeTemplates} active</span> </div> </div> <!-- Universal Sources --> <div class="bg-white rounded-2xl p-4 border border-gray-100 hover:shadow-lg transition-all duration-200"> <div class="flex items-center justify-between"> <div> <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Universal</p> <p class="text-xl font-bold text-cyan-600 mt-1">${totalMasterSources}</p> </div> <div class="w-9 h-9 bg-cyan-50 rounded-xl flex items-center justify-center text-cyan-600"> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path> </svg> </div> </div> <div class="mt-2 flex items-center gap-1 text-xs text-gray-400"> <span class="w-1 h-1 rounded-full bg-cyan-500"></span> <span>global sources</span> </div> </div> <!-- State Sources --> <div class="bg-white rounded-2xl p-4 border border-gray-100 hover:shadow-lg transition-all duration-200"> <div class="flex items-center justify-between"> <div> <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">State</p> <p class="text-xl font-bold text-teal-600 mt-1">${totalStateSources}</p> </div> <div class="w-9 h-9 bg-teal-50 rounded-xl flex items-center justify-center text-teal-600"> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path> </svg> </div> </div> <div class="mt-2 flex items-center gap-1 text-xs text-gray-400"> <span class="w-1 h-1 rounded-full bg-teal-500"></span> <span>state-specific</span> </div> </div> <!-- Media --> <div class="bg-white rounded-2xl p-4 border border-gray-100 hover:shadow-lg transition-all duration-200"> <div class="flex items-center justify-between"> <div> <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Media</p> <p class="text-xl font-bold text-pink-600 mt-1">${totalMedia}</p> </div> <div class="w-9 h-9 bg-pink-50 rounded-xl flex items-center justify-center text-pink-600"> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path> </svg> </div> </div> <div class="mt-2 flex items-center gap-1 text-xs text-gray-400"> <span class="w-1 h-1 rounded-full bg-pink-500"></span> <span>files uploaded</span> </div> </div> <!-- Total Sources --> <div class="bg-white rounded-2xl p-4 border border-gray-100 hover:shadow-lg transition-all duration-200"> <div class="flex items-center justify-between"> <div> <p class="text-xs font-medium text-gray-400 uppercase tracking-wider">Total Sources</p> <p class="text-xl font-bold text-gray-900 mt-1">${totalSources}</p> </div> <div class="w-9 h-9 bg-gray-50 rounded-xl flex items-center justify-center text-gray-600"> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path> </svg> </div> </div> <div class="mt-2 flex items-center gap-1 text-xs text-gray-400"> <span class="w-1 h-1 rounded-full bg-gray-500"></span> <span>${totalMasterSources + totalStateSources} total</span> </div> </div> </div>  <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8"> <a href="/admin/new" class="group bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-5 border border-blue-100 hover:shadow-md transition-all duration-200"> <div class="flex items-center gap-4"> <div class="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center text-blue-600 group-hover:scale-110 transition-transform"> <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path> </svg> </div> <div> <h3 class="font-semibold text-gray-900">Create New Post</h3> <p class="text-sm text-gray-500">Write and publish a new article</p> </div> </div> </a> <a href="/admin/products/new" class="group bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-5 border border-orange-100 hover:shadow-md transition-all duration-200"> <div class="flex items-center gap-4"> <div class="w-12 h-12 bg-orange-100 rounded-xl flex items-center justify-center text-orange-600 group-hover:scale-110 transition-transform"> <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path> </svg> </div> <div> <h3 class="font-semibold text-gray-900">Add Product</h3> <p class="text-sm text-gray-500">Create a new product listing</p> </div> </div> </a> <a href="/admin/media" class="group bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-5 border border-green-100 hover:shadow-md transition-all duration-200"> <div class="flex items-center gap-4"> <div class="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center text-green-600 group-hover:scale-110 transition-transform"> <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path> </svg> </div> <div> <h3 class="font-semibold text-gray-900">Media Library</h3> <p class="text-sm text-gray-500">Manage images and videos</p> </div> </div> </a> <a href="/admin/sources" class="group bg-gradient-to-r from-cyan-50 to-teal-50 rounded-2xl p-5 border border-cyan-100 hover:shadow-md transition-all duration-200"> <div class="flex items-center gap-4"> <div class="w-12 h-12 bg-cyan-100 rounded-xl flex items-center justify-center text-cyan-600 group-hover:scale-110 transition-transform"> <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path> </svg> </div> <div> <h3 class="font-semibold text-gray-900">Manage Sources</h3> <p class="text-sm text-gray-500">Add universal and state sources</p> </div> </div> </a> </div>  <div> <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4"> <div> <h2 class="text-lg font-semibold text-gray-900">All Posts</h2> <p class="text-sm text-gray-500">Manage your articles</p> </div> <div class="flex items-center gap-3"> <div class="relative"> <input type="text" id="searchInput" placeholder="Search posts..." class="pl-9 pr-4 py-2 text-sm border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 w-40 sm:w-48"> <svg class="w-4 h-4 text-gray-400 absolute left-3 top-1/2 -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path> </svg> </div> <a href="/admin/new" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-xl transition-all duration-200 flex items-center gap-1.5"> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path> </svg>
New
