...
</span> </div> </div> <div class="stat-actions"> <a href="/admin/sources" class="stat-action-link">View All →</a> <a href="/admin/sources/new" class="stat-action-btn stat-action-btn-cyan">+ New Source</a> </div> </div> </div>    <div class="recent-posts-section"> <div class="section-header"> <div> <h2 class="section-title">📄 Recent Posts</h2> <p class="section-subtitle">Your latest published and draft articles</p> </div> <div class="section-actions"> <div class="search-wrapper"> <svg class="search-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"> <circle cx="11" cy="11" r="8"></circle> <line x1="21" y1="21" x2="16.65" y2="16.65"></line> </svg> <input type="text" id="searchInput" placeholder="Search posts..." class="search-input"> </div> <a href="/admin/new" class="btn-new-post"> <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"> <line x1="12" y1="5" x2="12" y2="19"></line> <line x1="5" y1="12" x2="19" y2="12"></line> </svg>
New Post
</a> </div> </div> <div class="table-container"> ${posts.length > 0 ? renderTemplate`<div class="table-scroll"> <table class="posts-table"> <thead> <tr> <th>Title</th> <th class="status-col">Status</th> <th class="date-col">Published</th> <th class="actions-col">Actions</th> </tr> </thead> <tbody> ${posts.slice(0, 5).map((post) => renderTemplate`<tr${addAttribute(post.id, "key")}> <td> <div class="post-title-cell"> <span class="post-title">${post.title}</span> </div> </td> <td class="status-col"> <span${addAttribute(`status-badge ${post.is_draft ? "status-draft" : "status-published"}`, "class")}> <span class="status-dot"></span> ${post.is_draft ? "Draft" : "Published"} </span> </td> <td class="date-col"> ${post.published_at ? new Date(post.published_at).toLocaleDateString("en-US", {
    month: "short",
    day: "numeric",
    year: "numeric"
  }) : "\u2014"} </td> <td class="actions-col"> <div class="action-buttons"> <a${addAttribute(`/admin/edit/${post.id}`, "href")} class="action-btn action-btn-edit"> <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"> <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path> <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path> </svg>
Edit
</a> <button class="action-btn action-btn-delete delete-btn"${addAttribute(post.id, "data-id")}> <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"> <polyline points="3 6 5 6 21 6"></polyline> <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path> </svg>
Delete
</button> </div> </td> </tr>`)} </tbody> </table> </div>` : renderTemplate`<div class="empty-state"> <div class="empty-icon">📝</div> <p>No posts yet</p> <a href="/admin/new" class="empty-action">Create your first post →</a> </div>`} </div> ${posts.length > 5 && renderTemplate`<div class="view-all-container"> <a href="/admin/posts" class="view-all-link">
View all ${posts.length} posts →
</a> </div>`} </div> ` })} <!-- ============================================ --> <!-- DELETE FUNCTIONALITY --> <!-- ============================================ --> ${renderScript($$result, "P:/Projects/trendlin/src/pages/admin/dashboard.astro?astro&type=script&index=0&lang.ts")} `;
