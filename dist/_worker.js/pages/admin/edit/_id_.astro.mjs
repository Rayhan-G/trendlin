...
Update Post
</button> </div> </div> <!-- Status Message --> <div id="statusMessage" class="hidden p-4 rounded-xl"></div> </form>` : null} </div> ` })} ${renderScript($$result, "P:/Projects/trendlin/src/pages/admin/edit/[id].astro?astro&type=script&index=0&lang.ts")} `;
