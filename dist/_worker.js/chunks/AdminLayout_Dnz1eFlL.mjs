...
</a> <!-- ADD SOURCES LINK HERE --> <a href="/admin/sources"${addAttribute(Astro2.url.pathname === "/admin/sources" ? "active" : "", "class")} data-astro-cid-2kanml4j> <span class="icon" data-astro-cid-2kanml4j>📚</span> Sources
...
</a> <a href="/admin/settings"${addAttribute(Astro2.url.pathname === "/admin/settings" ? "active" : "", "class")} data-astro-cid-2kanml4j> <span class="icon" data-astro-cid-2kanml4j>⚙️</span> Settings
