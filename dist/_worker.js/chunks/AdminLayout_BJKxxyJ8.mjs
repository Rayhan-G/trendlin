...
</a> <!-- CONTENT SECTION - 5 FEATURES --> <div class="nav-label" style="margin-top: 0.5rem;" data-astro-cid-2kanml4j>Content</div> <!-- 1. POSTS --> <a href="/admin/posts"${addAttribute(Astro2.url.pathname === "/admin/posts" ? "active" : "", "class")} data-astro-cid-2kanml4j> <span class="icon" data-astro-cid-2kanml4j>📄</span> Posts
