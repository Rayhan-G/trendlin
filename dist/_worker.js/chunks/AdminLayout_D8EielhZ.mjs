...
import { c as createAstro, a as createComponent, b as addAttribute, r as renderHead, d as renderTemplate, e as renderSlot, f as renderScript } from './astro/server_DVHrQl8d.mjs';
/* empty css                             */
...
const $$AdminLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" data-astro-cid-2kanml4j> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>${title} - Trendlin Admin</title><meta name="description"${addAttribute(description, "content")}><link rel="icon" type="image/svg+xml" href="/favicon.svg"><!-- Google Fonts --><link href="https://fonts.googleapis.com/css2?family=Inter:opsz,wght@14..32,400;14..32,500;14..32,600;14..32,700;14..32,800&display=swap" rel="stylesheet">${renderHead()}</head> <body data-astro-cid-2kanml4j> <!-- ==========================================
    ...
    ========================================== --> <aside class="sidebar" id="sidebar" data-astro-cid-2kanml4j> <nav class="sidebar-nav" data-astro-cid-2kanml4j> <div class="nav-label" data-astro-cid-2kanml4j>Main</div> <a href="/admin/dashboard"${addAttribute(Astro2.url.pathname === "/admin/dashboard" ? "active" : "", "class")} data-astro-cid-2kanml4j> <span class="icon" data-astro-cid-2kanml4j>📊</span> Dashboard
</a> <a href="/admin/new"${addAttribute(Astro2.url.pathname === "/admin/new" ? "active" : "", "class")} data-astro-cid-2kanml4j> <span class="icon" data-astro-cid-2kanml4j>✏️</span> New Post
</a> <div class="nav-label" style="margin-top: 0.5rem;" data-astro-cid-2kanml4j>Content</div> <a href="/admin/media"${addAttribute(Astro2.url.pathname.startsWith("/admin/media") ? "active" : "", "class")} data-astro-cid-2kanml4j> <span class="icon" data-astro-cid-2kanml4j>🖼️</span> Media Library
</a> <a href="/admin/products"${addAttribute(Astro2.url.pathname.startsWith("/admin/products") ? "active" : "", "class")} data-astro-cid-2kanml4j> <span class="icon" data-astro-cid-2kanml4j>📦</span> Products
</a> <a href="/admin/templates"${addAttribute(Astro2.url.pathname === "/admin/templates" ? "active" : "", "class")} data-astro-cid-2kanml4j> <span class="icon" data-astro-cid-2kanml4j>📋</span> Templates
</a> <a href="/admin/sources"${addAttribute(Astro2.url.pathname === "/admin/sources" ? "active" : "", "class")} data-astro-cid-2kanml4j> <span class="icon" data-astro-cid-2kanml4j>📚</span> Sources
</a> <div class="nav-label" style="margin-top: 0.5rem;" data-astro-cid-2kanml4j>System</div> <a href="/" target="_blank" data-astro-cid-2kanml4j> <span class="icon" data-astro-cid-2kanml4j>🌐</span> View Site
</a> <div style="border-top: 1px solid var(--border-color); margin-top: 0.75rem; padding-top: 0.75rem;" data-astro-cid-2kanml4j> <form method="POST" action="/api/auth/logout" data-astro-cid-2kanml4j> <button type="submit" style="display:flex;align-items:center;gap:0.75rem;width:100%;padding:0.625rem 0.75rem;border:none;background:transparent;border-radius:0.5rem;font-size:0.875rem;font-weight:500;color:#dc2626;cursor:pointer;transition:background 0.2s;font-family:inherit;" data-astro-cid-2kanml4j> <span class="icon" data-astro-cid-2kanml4j>🚪</span> Logout
</button> </form> </div> </nav> </aside> <!-- ==========================================
    MAIN CONTENT
    ========================================== --> <div class="admin-wrapper" data-astro-cid-2kanml4j> <div class="main-content" data-astro-cid-2kanml4j> <!-- Page Header --> <div class="page-header" data-astro-cid-2kanml4j> <h1 data-astro-cid-2kanml4j>${title}</h1> ${description && renderTemplate`<p data-astro-cid-2kanml4j>${description}</p>`} </div> <!-- Slot content --> ${renderSlot($$result, $$slots["default"])} </div> </div> <!-- ==========================================
    JAVASCRIPT
