...
import { c as createAstro, a as createComponent, m as maybeRenderHead, b as addAttribute, g as renderComponent, F as Fragment, d as renderTemplate, f as renderScript } from './astro/server_DVHrQl8d.mjs';
/* empty css                         */
...
const $$Footer = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer class="bg-white dark:bg-gray-900 border-t border-gray-200/50 dark:border-gray-800/50"> <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10"> <!-- Main Footer --> <div class="py-14 sm:py-18"> <div class="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8"> <!-- Brand Column --> <div class="lg:col-span-2"> <a href="/" class="flex items-center gap-2.5 mb-5 group"> <div class="w-9 h-9 lg:w-10 lg:h-10 bg-gradient-to-br from-blue-600 to-purple-600 rounded-xl flex items-center justify-center text-white font-bold text-base shadow-lg shadow-blue-500/25 group-hover:shadow-blue-500/40 transition-all duration-300 group-hover:scale-105">
T
