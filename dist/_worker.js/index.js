...
import { manifest } from './manifest_BlGbbYcZ.mjs';
...
const _page19 = () => import('./pages/api/email-auto-reply.astro.mjs');
const _page20 = () => import('./pages/api/images/_---path_.astro.mjs');
const _page21 = () => import('./pages/api/posts.astro.mjs');
const _page22 = () => import('./pages/api/upload.astro.mjs');
const _page23 = () => import('./pages/categories.astro.mjs');
const _page24 = () => import('./pages/contact.astro.mjs');
const _page25 = () => import('./pages/cookies.astro.mjs');
const _page26 = () => import('./pages/disclosure.astro.mjs');
const _page27 = () => import('./pages/posts/_slug_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/email-auto-reply.js", _page19],
    ["src/pages/api/images/[...path].js", _page20],
    ["src/pages/api/posts.ts", _page21],
    ["src/pages/api/upload/index.js", _page22],
    ["src/pages/categories/index.astro", _page23],
    ["src/pages/contact.astro", _page24],
    ["src/pages/cookies.astro", _page25],
    ["src/pages/disclosure.astro", _page26],
    ["src/pages/posts/[slug].astro", _page27],
