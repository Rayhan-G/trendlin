// src/components/category/entertainment/EntertainmentCategory.js
...
export default function EntertainmentCategory() {
  ...
  const color = '#ec4899' // Entertainment pink color
  ...
  const fetchPosts = async () => {
    try {
      setLoading(true)
      setError(null)
      const data = await getCategoryPosts('entertainment', 100)
      ...
      const enhancedPosts = (data || []).map(post => ({
        ...
        author: post.author || 'Entertainment Weekly',
        tags: post.tags || ['entertainment', 'pop culture']
      }))
    ...
    return (
      <div className="loading-container">
        <div className="loading-content">
          ...
          <p className="loading-text">Loading entertainment buzz...</p>
  ...
  return (
    <div className="entertainment-category">
      ...
      <div className="filter-section">
        <div className="filter-header">
          <div className="filter-info">
            <h3>
              {filterStats.filtered} {filterStats.filtered === 1 ? 'Show' : 'Shows'} &amp; Entertainment
            </h3>
      ...
      <style jsx>{`
        ...
        :global(html.dark) .entertainment-category {
          background: #0a0a0a;
        }
