...
export default function LifestyleHero() {
  ...
  const lifestylePillars = [
    { name: 'Travel & Destinations', icon: '✈️', description: 'Wanderlust, adventures & travel guides', gradient: 'linear-gradient(135deg, #3b82f6, #2563eb)' },
    { name: 'Fashion & Style', icon: '👗', description: 'Trends, outfits & personal style', gradient: 'linear-gradient(135deg, #ec4899, #be185d)' },
    { name: 'Food & Recipes', icon: '🍳', description: 'Cooking, dining & culinary adventures', gradient: 'linear-gradient(135deg, #f59e0b, #d97706)' },
    { name: 'Home & Living', icon: '🏠', description: 'Decor, organization & cozy spaces', gradient: 'linear-gradient(135deg, #10b981, #059669)' },
    { name: 'Beauty & Skincare', icon: '💄', description: 'Routines, products & self-care', gradient: 'linear-gradient(135deg, #f43f5e, #e11d48)' },
    { name: 'Relationships', icon: '💕', description: 'Dating, friendships & connections', gradient: 'linear-gradient(135deg, #8b5cf6, #7c3aed)' }
  ]

  const subCategories = [
    { name: "Minimalism", icon: '🌿' },
    { name: "Luxury Lifestyle", icon: '💎' },
    { name: "Social Media Tips", icon: '📱' },
    { name: "Hobbies & Leisure", icon: '🎨' },
    { name: "Daily Living", icon: '☀️' },
    ...
    <div className={`lifestyle-hero ${isDarkMode ? 'dark-mode' : 'light-mode'}`}>
      ...
      <div className="hero-container">
        <div className="hero-left">
          ...
          <div className="hero-badge">
            ...
            <span className="badge-text">Complete Lifestyle & Living Hub</span>
            <span className="badge-pulse"></span>
          </div>

          {/* Title */}
          <h1 className="hero-title">
            <span className="title-gradient">Your Lifestyle</span>
            <br />
            <span className="title-wave">Live Beautifully</span>
          </h1>
      ...
      <style jsx>{`
        ...
        @media (max-width: 640px) {
          .lifestyle-hero { margin-top: -56px; padding-top: 56px; }
