// src/components/category/world/WorldHero.js
...
export default function WorldHero() {
  ...
  // World categories
  const worldPillars = [
    { name: 'Global News', icon: '📰', description: 'Breaking news & major events worldwide', gradient: 'linear-gradient(135deg, #06b6d4, #0891b2)' },
    { name: 'Politics', icon: '🏛️', description: 'Elections, policies & international relations', gradient: 'linear-gradient(135deg, #3b82f6, #2563eb)' },
    { name: 'Economy', icon: '📊', description: 'Markets, trade & financial trends', gradient: 'linear-gradient(135deg, #10b981, #059669)' },
    { name: 'Technology', icon: '💻', description: 'Innovation, digital transformation & AI', gradient: 'linear-gradient(135deg, #8b5cf6, #7c3aed)' },
    { name: 'Environment', icon: '🌿', description: 'Climate change, sustainability & nature', gradient: 'linear-gradient(135deg, #22c55e, #16a34a)' },
    { name: 'Society & Culture', icon: '👥', description: 'Global trends, human stories & insights', gradient: 'linear-gradient(135deg, #f59e0b, #d97706)' }
  ]

  const subCategories = [
    { name: "Breaking News", icon: '🔴' },
    { name: "Conflicts", icon: '⚔️' },
    { name: "Business News", icon: '💼' },
    { name: "International Relations", icon: '🤝' },
    { name: "Human Stories", icon: '💙' },
    { name: "Cultural Insights", icon: '🎭' }
  ]
  ...
  return (
    <div className={`world-hero ${isDarkMode ? 'dark-mode' : 'light-mode'}`}>
      ...
      <div className="hero-container">
        <div className="hero-left">
          ...
          <div className="hero-badge">
            ...
            <span className="badge-text">Complete World News Hub</span>
            <span className="badge-pulse"></span>
          </div>

          {/* Title */}
          <h1 className="hero-title">
            <span className="title-gradient">World &</span>
            <br />
            <span className="title-wave">Global Insights</span>
          </h1>

          {/* Description */}
          <p className="hero-description">
            Breaking news, international affairs, global perspectives, and in-depth coverage from around the world.
          </p>
          ...
          <div className="stats-wrapper">
            <div className="stat-block">
              ...
              <div className="stat-label">World posts</div>
            </div>
            ...
            <div className="stat-block">
              ...
              <div className="stat-label">World rating</div>
