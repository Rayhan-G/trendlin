...
export default function HealthHero() {
  ...
  const healthPillars = [
    ...
    { name: 'Nutrition', icon: '🥗', description: 'Diet, weight loss & healthy eating', gradient: 'linear-gradient(135deg, #22c55e, #16a34a)' },
    { name: 'Mental Health', icon: '🧠', description: 'Stress, mindfulness & therapy', gradient: 'linear-gradient(135deg, #8b5cf6, #7c3aed)' },
    { name: 'Sleep & Recovery', icon: '😴', description: 'Rest, recovery & sleep hygiene', gradient: 'linear-gradient(135deg, #3b82f6, #2563eb)' },
    { name: 'Medical Care', icon: '🏥', description: 'Symptoms, treatments & prevention', gradient: 'linear-gradient(135deg, #ef4444, #dc2626)' },
    { name: 'Holistic Health', icon: '🌿', description: 'Home remedies, supplements & wellness', gradient: 'linear-gradient(135deg, #10b981, #059669)' }
  ]

  const subCategories = [
    { name: "Women's Health", icon: '👩' },
    { name: "Men's Health", icon: '👨' },
    { name: "Fitness Gear", icon: '🏋️' },
    { name: "Vitamins", icon: '💊' },
    { name: "Home Remedies", icon: '🍯' },
    ...
    <div className={`health-hero ${isDarkMode ? 'dark-mode' : 'light-mode'}`}>
      ...
      <div className="hero-container">
        <div className="hero-left">
          <div className="hero-badge">
            ...
            <span className="badge-text">Complete Health & Wellness Hub</span>
            <span className="badge-pulse"></span>
          </div>

          <h1 className="hero-title">
            <span className="title-gradient">Your Health</span>
            <br />
            <span className="title-wave">Your Wellness Journey</span>
          </h1>
      ...
      <style jsx>{`
        ...
        @media (max-width: 640px) {
          .health-hero { margin-top: -56px; padding-top: 56px; }
