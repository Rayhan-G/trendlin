  ...
  useEffect(() => {
    async function fetchStats() {
      try {
        ...
        console.error('Error fetching wealth stats:', error)
        setStats({
          totalPosts: 0,
          totalSubscribers: 0,
          averageRating: 0,
        ...
        <div className="hero-left">
          ...
          <div className="stats-wrapper">
            <div className="stat-block">
              ...
              <div className="stat-label">Wealth posts</div>
            </div>
            ...
            <div className="stat-block">
              ...
              <div className="stat-label">Wealth rating</div>
