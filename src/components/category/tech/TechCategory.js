// src/components/category/tech/TechCategory.js
...
export default function TechCategory() {
  ...
  const color = '#3b82f6' // Tech blue color
  ...
  const fetchPosts = async () => {
    try {
      setLoading(true)
      setError(null)
      const data = await getCategoryPosts('tech', 100)
      ...
      const enhancedPosts = (data || []).map(post => ({
        ...
        author: post.author || 'Tech Expert',
      ...
      setError('Failed to load tech content. Please try again later.')
    } finally {
      setLoading(false)
    }
  }
    ...
    return (
      <div className="loading-container">
        <div className="loading-content">
          ...
          <p className="loading-text">Loading tech innovations...</p>
  ...
  return (
    <div className="tech-category">
      ...
      <div className="filter-section">
        <div className="filter-header">
          <div className="filter-info">
            <h3>
              {filterStats.filtered} {filterStats.filtered === 1 ? 'Article' : 'Articles'} Found
            </h3>
      ...
      <style jsx>{`
        ...
        :global(html.dark) .tech-category {
          background: #0a0a0a;
        }
