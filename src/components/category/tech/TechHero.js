...
export default function TechHero() {
  ...
  // Tech categories
  const techPillars = [
    { name: 'AI & Tools', icon: '🤖', description: 'Machine learning, automation & AI assistants', gradient: 'linear-gradient(135deg, #3b82f6, #2563eb)' },
    { name: 'Software & Apps', icon: '📱', description: 'Productivity apps, software reviews & updates', gradient: 'linear-gradient(135deg, #8b5cf6, #7c3aed)' },
    { name: 'Gadgets & Reviews', icon: '📱', description: 'Smartphones, laptops & tech comparisons', gradient: 'linear-gradient(135deg, #06b6d4, #0891b2)' },
    { name: 'Programming', icon: '💻', description: 'Development, coding tips & best practices', gradient: 'linear-gradient(135deg, #10b981, #059669)' },
    { name: 'Cybersecurity', icon: '🔒', description: 'Privacy, security tips & data protection', gradient: 'linear-gradient(135deg, #ef4444, #dc2626)' },
    { name: 'Future Tech', icon: '🚀', description: 'Innovations, space tech & emerging trends', gradient: 'linear-gradient(135deg, #f59e0b, #d97706)' }
  ]
      ...
      <div className="hero-container">
        <div className="hero-left">
          ...
          <div className="hero-badge">
            ...
            <span className="badge-text">Complete Technology Hub</span>
          ...
          <h1 className="hero-title">
            ...
            <br />
            <span className="title-wave">Digital Innovation</span>
          </h1>
