...
export default function CategoryFilters({ onSearch, onSort, onFilter, color = '#6366f1', totalResults, categoryType = 'general' }) {
  ...
  const categoryConfigs = {
    health: {
      ...
      categories: [
        ...
        'Sleep & Recovery', 'Diseases & Treatments', 'Nutrition & Healthy Eating',
        'Home Remedies', 'Supplements & Vitamins', 'Medical Awareness',
        "Women's Health", "Men's Health", 'Fitness Gear'
      ]
    },
    wealth: {
      ...
      categories: [
        'All', 'Make Money Online', 'Side Hustles', 'Investing',
        'Saving & Budgeting', 'Financial Freedom', 'Passive Income',
        'Business & Entrepreneurship', 'Shopping Deals', 'E-commerce Tips',
        'Remote Jobs', 'Digital Products', 'Business Case Studies'
      ]
    },
    tech: {
      title: 'Technology',
      ...
      categories: [
        ...
        'Smartphones & Laptops', 'How-to Tutorials', 'Tech News',
        'Best Comparisons', 'Productivity Apps', 'Future Tech',
        'Programming', 'Cybersecurity', 'Tech Troubleshooting'
      ]
    },
    growth: {
      ...
      categories: [
        'All', 'Study Methods', 'Online Courses', 'Skill Learning',
        'Productivity & Habits', 'Self-Improvement', 'Time Management',
        'Focus & Deep Work', 'Career Skills', 'Motivation & Mindset',
        'Goal Setting', 'Learning Techniques', 'Personal Branding'
      ]
    },
    entertainment: {
      title: 'Entertainment',
      ...
      categories: [
        ...
        'Internet Culture', 'Trending Topics', 'Reviews & Recommendations',
        'Streaming Content', 'Fun Content', 'Behind-the-Scenes',
        'Fan Theories', 'Upcoming Releases'
      ]
    },
    world: {
      title: 'World News',
      ...
      categories: [
        'All', 'Global News', 'Politics', 'Economy', 'Major Events',
        'Business News', 'Technology News', 'Environment & Climate',
        'Global Trends', 'Breaking News', 'International Relations',
        'Cultural Insights', 'Human Stories'
      ]
    },
    lifestyle: {
      title: 'Lifestyle',
      ...
      categories: [
        'All', 'Travel & Destinations', 'Relationships', 'Life Advice',
        'Social Media Tips', 'Daily Lifestyle', 'Fashion & Style',
        'Food & Recipes', 'Home & Living', 'Minimalism',
        'Beauty & Skincare', 'Luxury Lifestyle', 'Hobbies'
      ]
    },
    general: {
      title: 'Categories',
  ...
  const clearAllFilters = () => {
    const resetFilters = { category: 'all', dateRange: 'all' }
  ...
  const categoryIcons = {
    ...
    'Mental Health & Stress': '🧠', 'Sleep & Recovery': '😴', 'Diseases & Treatments': '🩺',
    'Nutrition & Healthy Eating': '🍎', 'Home Remedies': '🌿', 'Supplements & Vitamins': '💊',
    'Medical Awareness': '⚠️', "Women's Health": '👩', "Men's Health": '👨',
    'Fitness Gear': '🏋️', 'Make Money Online': '💻', 'Side Hustles': '⚡',
    'Investing': '📈', 'Saving & Budgeting': '💰', 'Financial Freedom': '🦅',
    'Passive Income': '💤', 'Business & Entrepreneurship': '🚀', 'Shopping Deals': '🛍️',
    'E-commerce Tips': '🔗', 'Remote Jobs': '🏠', 'Digital Products': '📦',
    'Business Case Studies': '📚', 'AI & Tools': '🤖', 'Software & Apps': '📱',
    'Gadgets & Reviews': '📱', 'Smartphones & Laptops': '💻', 'How-to Tutorials': '📖',
    'Tech News': '📰', 'Best Comparisons': '⚖️', 'Productivity Apps': '🛠️',
    'Future Tech': '🔮', 'Programming': '💻', 'Cybersecurity': '🔒',
    'Tech Troubleshooting': '🔧', 'Study Methods': '📚', 'Online Courses': '💻',
    'Skill Learning': '🎨', 'Productivity & Habits': '⚡', 'Self-Improvement': '💪',
    'Time Management': '⏰', 'Focus & Deep Work': '🎯', 'Career Skills': '📈',
    'Motivation & Mindset': '🧠', 'Goal Setting': '📋', 'Learning Techniques': '🧩',
    'Personal Branding': '✨', 'Movies & Series': '🎬', 'Gaming': '🎮',
    'Music': '🎵', 'Celebrities': '⭐', 'Internet Culture': '📱',
    'Trending Topics': '🔥', 'Reviews & Recommendations': '⭐', 'Streaming Content': '📺',
    'Fun Content': '😂', 'Behind-the-Scenes': '🎬', 'Fan Theories': '💭',
    'Upcoming Releases': '🎥', 'Global News': '🌐', 'Politics': '🏛️',
    'Economy': '📊', 'Major Events': '⚠️', 'Business News': '💼',
    'Technology News': '🤖', 'Environment & Climate': '🌱', 'Global Trends': '👥',
    'Breaking News': '🔴', 'International Relations': '🤝', 'Cultural Insights': '🎭',
    'Human Stories': '❤️', 'Travel & Destinations': '✈️', 'Relationships': '💕',
    'Life Advice': '💬', 'Social Media Tips': '📱', 'Daily Lifestyle': '📅',
    'Fashion & Style': '👗', 'Food & Recipes': '🍳', 'Home & Living': '🏠',
    'Minimalism': '🎨', 'Beauty & Skincare': '💄', 'Luxury Lifestyle': '💎',
    'Hobbies': '🎯'
  }
  ...
  return (
    <div className="filters-wrapper">
          ...
          {isFilterOpen && (
            <div className="filter-dropdown">
              ...
              <div className="filter-dropdown-content">
                {/* Categories Section - Grid Layout Only */}
                <div className="filter-section">
                  ...
                  <div className="categories-grid">
                    {categories.map(cat => (
                      <button
                        key={cat}
                        className={`category-grid-item ${activeFilters.category === formatCategoryValue(cat) ? 'active' : ''}`}
      ...
      <style jsx>{`
        ...
        /* Categories Grid - GRID LAYOUT ONLY */
        .categories-grid {
          display: grid;
        ...
        :global(html.dark) .category-grid-item {
          background: #333;
          border-color: #4a4a4a;
          color: #e5e7eb;
        }
