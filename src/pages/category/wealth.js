  ...
  return (
    <Layout>
          ...
          <div className="hero-container">
            <div className="hero-content">
              ...
              <h1 className="hero-title">
                Wealth &<br />
                <span className="hero-title-accent">Finance</span>
              </h1>
              <p className="hero-description">
                Expert insights on investing, saving, and building lasting financial freedom.
              </p>
      ...
      <style jsx>{`
        ...
        /* Hero Section - Wealth Theme (Gold/Amber) */
        .hero {
          position: relative;
          min-height: 70vh;
          display: flex;
