...
export default function WealthCategory() {
  ...
  const categoryPosts = allPosts.filter(post => 
    post.category?.toLowerCase() === 'wealth'
  )
  ...
  return (
    <Layout>
        ...
        <div className="container hero-container">
          <div className="hero-content">
            ...
            <p className="hero-text">
              Smart investing strategies, money management tips, and wealth-building insights.
            </p>
        ...
        <div className="container">
          <div className="filter-row">
            ...
            <div className="search-wrapper">
              ...
              <input 
                type="text" 
                placeholder="Search wealth articles..." 
                value={searchTerm}
      ...
      <style jsx>{`
        ...
        .empty-btn { padding: 0.6rem 1.5rem; background: #f59e0b; color: white; border: none; border-radius: 40px; cursor: pointer; }
