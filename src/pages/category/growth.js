...
import { getPopularPosts } from '@/utils/popularityTracker'

export default function GrowthCategory() {
  const allPosts = blogData.posts || []
  const categoryPosts = allPosts.filter(post => 
    post.category?.toLowerCase() === 'growth' || post.category?.toLowerCase() === 'productivity'
  )
  ...
  // Fetch real popular posts data from Supabase
  useEffect(() => {
    async function fetchPopularData() {
      const popular = await getPopularPosts(50)
      const popularMap = {}
      popular.forEach(post => {
        popularMap[post.id] = post.monthly_views || 0
      })
      setPopularPostsData(popularMap)
    }
    fetchPopularData()
  }, [])
  ...
  if (sortBy === 'newest') {
    ...
    filteredPosts.sort((a, b) => (popularPostsData[b.id] || 0) - (popularPostsData[a.id] || 0))
  }
    ...
    <Layout>
        ...
        <div className="container hero-container">
          <div className="hero-content">
            ...
            <h1 className="hero-title">
              Unlock Your<br />
              <span className="hero-highlight">Full Potential</span>
            </h1>
            <p className="hero-text">
              Personal development, productivity hacks, and self-improvement strategies.
            </p>
      ...
      <div className="container">
        <div className="results-header">
          ...
          {sortBy === 'popular' && (
            <span className="popular-badge">🔥 Based on real monthly views</span>
          )}
        </div>
      ...
      <style jsx>{`
        ...
        :global(body.dark) .popular-badge {
          background: #064e3b;
          color: #34d399;
        }
        
        /* ============================================ */
        /* RESPONSIVE GRID - CRITICAL SECTION */
        /* ============================================ */
        ...
        /* TABLET: 3 COLUMNS (SAME AS MOBILE REQUEST) */
        ...
        /* SMALL MOBILE: 2 COLUMNS (for very small screens) */
        ...
        .empty-btn { padding: 0.6rem 1.5rem; background: #059669; color: white; border: none; border-radius: 40px; cursor: pointer; }
