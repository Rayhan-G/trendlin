...
export default function WorldCategory() {
  ...
  const categoryPosts = allPosts.filter(post => 
    post.category?.toLowerCase() === 'world'
  )
  ...
  return (
    <Layout>
        ...
        <div className="container hero-container">
          <div className="hero-content">
            ...
            <h1 className="hero-title">
              Global<br />
              <span className="hero-highlight">Perspectives</span>
            </h1>
            <p className="hero-text">
              Global news, international affairs, and cultural insights from around the world.
            </p>
      ...
      <style jsx>{`
        ...
        .empty-btn { padding: 0.6rem 1.5rem; background: #14b8a6; color: white; border: none; border-radius: 40px; cursor: pointer; }
