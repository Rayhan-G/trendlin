...
export default function TechCategory() {
  ...
  const categoryPosts = allPosts.filter(post => 
    post.category?.toLowerCase() === 'tech' || post.category?.toLowerCase() === 'technology'
  )
  ...
  return (
    <Layout>
        ...
        <div className="container hero-container">
          <div className="hero-content">
            ...
            <h1 className="hero-title">
              Future is<br />
              <span className="hero-highlight">Now</span>
            </h1>
            <p className="hero-text">
              Latest gadgets, AI breakthroughs, and digital innovation shaping our world.
            </p>
      ...
      <style jsx>{`
        ...
        .empty-btn { padding: 0.6rem 1.5rem; background: #3b82f6; color: white; border: none; border-radius: 40px; cursor: pointer; }
