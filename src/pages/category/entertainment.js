  ...
  return (
    <Layout>
      <div className="category-page">
        {/* Hero Section - Entertainment Theme (Pink) */}
        <div className="hero">
          ...
          <div className="hero-container">
            <div className="hero-content">
              <div className="hero-badge">
                ...
                <span>Pop Culture Hub</span>
              </div>
              <h1 className="hero-title">
                Entertainment &<br />
                <span className="hero-title-accent">Pop Culture</span>
              </h1>
              <p className="hero-description">
                Movies, music, gaming, and celebrity news — your daily dose of entertainment.
              </p>
