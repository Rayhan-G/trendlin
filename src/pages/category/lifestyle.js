  ...
  return (
    <Layout>
      <div className="category-page">
        {/* Hero Section - Lifestyle Theme (Orange/Coral) */}
        <div className="hero">
          ...
          <div className="hero-container">
            <div className="hero-content">
              ...
              <h1 className="hero-title">
                Lifestyle &<br />
                <span className="hero-title-accent">Inspiration</span>
              </h1>
              <p className="hero-description">
                Fashion, travel, home decor, wellness, and everyday living inspiration.
              </p>
      ...
      <style jsx>{`
        ...
        .hero-bg-gradient {
          position: absolute;
          inset: 0;
          background: radial-gradient(circle at 70% 50%, rgba(249, 115, 22, 0.15), transparent 50%);
        }
