// src/components/category/entertainment/EntertainmentHero.js
...
export default function EntertainmentHero() {
  ...
  const entertainmentPillars = [
    { name: 'Movies & Series', icon: '🎬', description: 'Reviews, trailers & streaming guides', gradient: 'linear-gradient(135deg, #ec4899, #f43f5e)' },
    { name: 'Gaming', icon: '🎮', description: 'Game reviews, walkthroughs & esports', gradient: 'linear-gradient(135deg, #8b5cf6, #7c3aed)' },
    { name: 'Music', icon: '🎵', description: 'Album reviews, playlists & concerts', gradient: 'linear-gradient(135deg, #3b82f6, #2563eb)' },
    { name: 'Celebrities', icon: '⭐', description: 'News, interviews & red carpet', gradient: 'linear-gradient(135deg, #f59e0b, #d97706)' },
    { name: 'Internet Culture', icon: '🌐', description: 'Memes, trends & viral moments', gradient: 'linear-gradient(135deg, #10b981, #059669)' },
    { name: 'Streaming', icon: '📺', description: 'Netflix, Prime, Disney+ & more', gradient: 'linear-gradient(135deg, #ef4444, #dc2626)' }
  ]

  const subCategories = [
    { name: "Fan Theories", icon: '🔮' },
    { name: "Behind the Scenes", icon: '🎥' },
    { name: "Upcoming Releases", icon: '📅' },
    { name: "Reviews", icon: '⭐' },
  ...
  useEffect(() => {
    async function fetchStats() {
      try {
        ...
        if (error || !data) {
          ...
          if (!postsError && posts) {
            ...
            const { count: subscribersCount } = await supabase
              ...
              .contains('categories', ['entertainment'])
        ...
        console.error('Error fetching entertainment stats:', error)
        setStats({
          totalPosts: 10,
          totalSubscribers: 0,
          averageRating: 0,
  ...
  return (
    <div className={`entertainment-hero ${isDarkMode ? 'dark-mode' : 'light-mode'}`}>
      ...
      <div className="hero-container">
        <div className="hero-left">
          ...
          <div className="hero-badge">
            ...
            <span className="badge-text">Complete Entertainment Hub</span>
            <span className="badge-pulse"></span>
          </div>

          {/* Title */}
          <h1 className="hero-title">
            <span className="title-gradient">Your Entertainment</span>
            <br />
            <span className="title-wave">Daily Dose of Fun</span>
          </h1>

          {/* Description */}
          <p className="hero-description">
            Everything you need for movies, gaming, music, celebrity news, and internet culture — all in one place.
          </p>
          ...
          <div className="stats-wrapper">
            <div className="stat-block">
              ...
              <div className="stat-label">Entertainment posts</div>
            </div>

            <div className="stat-block">
              <div className="stat-number">{loading ? '...' : formatNumber(stats.totalSubscribers)}</div>
              <div className="stat-label">Entertainment subscribers</div>
            ...
            <div className="stat-block">
              ...
              <div className="stat-label">Entertainment rating</div>
        ...
        <div className="hero-right">
          <div className="categories-visual">
            ...
            <div className="pillars-grid">
              {entertainmentPillars.map((pillar, idx) => (
